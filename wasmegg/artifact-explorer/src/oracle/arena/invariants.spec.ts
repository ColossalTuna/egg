...
const COUNT = Number(process.env.ARENA_INSTANCES ?? (MODE === 'smoke' ? 4 : 40));
const SEED_BASE = Number(process.env.ARENA_SEED_BASE ?? 2000);
...
describe(`arena (${MODE}, ${COUNT} instances)`, () => {
