// Exact rational arithmetic over BigInt, used by the oracle's simplex solver.
// Deliberately independent of the optimizer's numeric code: the oracle must
// validate through disparate logic.
...
export class Frac {
  ...
  // Exact conversion of a finite double. Every finite double is p / 2^k for
  // integers p, k, so this loses nothing.
